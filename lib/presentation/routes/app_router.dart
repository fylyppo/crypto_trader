...
import 'package:crypto_trader/presentation/spot/spot_trade_page.dart';
...
@MaterialAutoRouter(
  ...
  routes: <AutoRoute>[
    ...
    AutoRoute(page: MainPage, guards: [
      AuthGuard
    ], children: [
      ...
      AutoRoute(
          path: 'current_price', page: LastTradesPage, maintainState: false),
    ]),
    AutoRoute(
      page: SignInPage,
    ),
